...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($restaurant_name)) {
        ...
        $result = addDineInReview($restaurant_name, $rating, $content);
        if ($result) {
            $success = '评价添加成功！';
            // 清空表单
                ...
                <div class="card-body">
                    ...
                    <?php if ($success): ?>
                        <div class="alert alert-success">
                            ...
                            <?php echo $success; ?>
                            <div class="mt-2">
                                <a href="dine_in.php" class="btn btn-sm btn-outline-success">
                                    <i class="bi bi-arrow-left me-1"></i> 返回列表
                                </a>
                                <a href="add_dine_in_review.php" class="btn btn-sm btn-outline-primary">
                    ...
                    <form method="POST" action="">
                        <div class="mb-3">
                            <label for="restaurant_name" class="form-label">餐厅名称</label>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="dine_in.php" class="btn btn-outline-secondary">
